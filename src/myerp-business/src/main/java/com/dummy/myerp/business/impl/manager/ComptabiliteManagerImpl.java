...
public class ComptabiliteManagerImpl extends AbstractBusinessManager implements ComptabiliteManager {
    ...
    public synchronized void addReference(EcritureComptable pEcritureComptable) throws NotFoundException {
        ...
        int vAnnee = calendar.get(Calendar.YEAR);
        try {
            //1.  Remonter depuis la persitance la dernière valeur de la séquence du journal pour l'année de l'écriture
            //        (table sequence_ecriture_comptable)
            SequenceEcritureComptable vSequenceEcritureComptable = getDaoProxy().getComptabiliteDao()
                    .getSequenceEcriturecomptableByAnneeAndJournal(vAnnee, pEcritureComptable.getJournal().getCode());
            ...
            String nouvelleReference = pEcritureComptable.getJournal().getCode() + "-"
                    + vAnnee + "/" + String.format("%05d" , vSequenceEcritureComptable.getDerniereValeur());
            pEcritureComptable.setReference(nouvelleReference);
           ...
           //<p><strong>Attention :</strong> l'écriture n'est pas enregistrée en persistance</p>
            ...
            vSequenceEcritureComptable.setAnnee(vAnnee);
